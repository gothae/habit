...
def updateUser():
    ...
    if request.method == 'GET':
        ...
        # sql = "update User set age='%s', user_pw={1}, weight={2}, height={3}, birth_date={4}, medicine={5}, phone_number={6} where user_id={7};".format(age, pw, weight, height, birth_date, medicine, phone_number, user_id)
        # cursor.execute(sql)
