...
#     patient_id = db.Column(db.String(20), db.ForeignKey('patient_register.patient_id'),unique =True, primary_key = True,nullable = False)
#     patient_pw = db.Column(db.String(20), db.ForeignKey('patient_register.patient_id'),nullable = False)
#     patient_name = db.Column(db.String(20), db.ForeignKey('patient_register.patient_name'),nullable=False)
